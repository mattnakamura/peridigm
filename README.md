# Peridigm [![Codacy Badge](https://app.codacy.com/project/badge/Grade/2d390b95b314447bac5673a07e7b4ea0)](https://www.codacy.com/gh/peridigm/peridigm/dashboard?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=peridigm/peridigm&amp;utm_campaign=Badge_Grade) [![Github Actions](https://github.com/peridigm/peridigm/actions/workflows/test.yml/badge.svg)](https://github.com/peridigm/peridigm/actions/workflows/test.yml) [![DOI (KOA fork)](https://zenodo.org/badge/DOI/10.5281/zenodo.20126668.svg)](https://doi.org/10.5281/zenodo.20126668)

> **Fork notice:** This is a fork of upstream Peridigm with patches required to build against the modern compiler/dependency stack on UH KOA HPC (GCC 13.2, HDF5 1.14.3, Trilinos 13.4.1). Behavior is unchanged from upstream. See [`CITATION.cff`](CITATION.cff) for attribution. Use the build pipeline at [mattnakamura/KOA_Peridigm_Install](https://github.com/mattnakamura/KOA_Peridigm_Install).
...
An overview of Peridigm is given in [The Peridigm Meshfree Peridynamics Code](https://doi.org/10.1007/s42102-023-00100-0), by Littlewood, Parks, Foster, Mitchell, and Diehl, J Peridyn Nonlocal Model, 2023, and in the 2012 [Peridigm Users' Guide](https://doi.org/10.2172/1055619). Further details on software for computational peridynamics can be found in the [Roadmap for Peridynamic Software Implementation](https://doi.org/10.2172/1226115).
